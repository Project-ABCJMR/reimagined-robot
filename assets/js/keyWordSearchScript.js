      ...
      if (response.ok) {
        ...
        data.records.forEach((record) => {
          if (
            ...
            const artistName = record.people && record.people[0]?.displayname || "";
						const birthDeathDate = record.people && record.people[0]?.displaydate || "";
						const culture = record.people && record.people[0]?.culture || "";
						const birthPlace = record.people && record.people[0]?.birthplace || "";
